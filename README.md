# css-test-1
/* Generated on: Mon Nov 01 2021 12:49:25 GMT+0000 (Coordinated Universal Time) */
/* ==========================================================================
...
.banner-flowbase {
  ...
  background-image: url("https://assets.website-files.com/617fc42a87aa4342f2049f9f/617fc42a87aa43618b049fba_Flowbase%20Bubble%20Right.png");
...
.toggle-flowbase {
  ...
  border-style: solid;
  border-width: 2px;
  border-color: rgba(120, 57, 243, 0.08);
  border-radius: 42px;
  background-color: rgba(120, 57, 243, 0.08);
  color: #7839f3;
}
...
.button-flowbase:active {
  border-color: #6f2fec;
  background-color: #6f2fec;
}

.button-flowbase:focus {
  border-color: #a385f5;
}
...
.form-image-overlay {
  ...
  background-image: linear-gradient(350deg, #fff, hsla(0, 0%, 100%, 0) 34%, hsla(0, 0%, 100%, 0));
}
...
.contact-field-large::-webkit-input-placeholder {
  color: #71717a;
}
